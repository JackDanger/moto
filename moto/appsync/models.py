...
class DataSource(BaseModel):
    def __init__(
        ...
        dynamodb_config: dict[str, Any] | None = None,
        lambda_config: dict[str, Any] | None = None,
        elasticsearch_config: dict[str, Any] | None = None,
        open_search_service_config: dict[str, Any] | None = None,
        http_config: dict[str, Any] | None = None,
        relational_database_config: dict[str, Any] | None = None,
        event_bridge_config: dict[str, Any] | None = None,
...
class AppSyncBackend(BaseBackend, TaggableResourcesMixin):
    ...
    def start_data_source_introspection(
        self, rds_data_api_config: dict[str, Any] | None = None
    ) -> str:
