...
url_paths = {
    ...
    r"{0}/(?P<api_version>[\d_-]+)/hostedzone/(?P<zone_id>[^/]+)/authorizevpcassociation/?$": Route53.dispatch,
    r"{0}/(?P<api_version>[\d_-]+)/hostedzone/(?P<zone_id>[^/]+)/deauthorizevpcassociation/?$": Route53.dispatch,
    ...
    r"{0}/(?P<api_version>[\d_-]+)/healthcheck/(?P<health_check_id>[^/]+)/lastfailurereason$": Route53.dispatch,
    ...
    r"{0}/(?P<api_version>[\d_-]+)/accountlimit/(?P<limit_type>[^/]+)$": Route53.dispatch,
    r"{0}/(?P<api_version>[\d_-]+)/hostedzonelimit/(?P<zone_id>[^/]+)/(?P<limit_type>[^/]+)$": Route53.dispatch,
    r"{0}/(?P<api_version>[\d_-]+)/reusabledelegationsetlimit/(?P<delegation_set_id>[^/]+)/(?P<limit_type>[^/]+)$": Route53.dispatch,
    r"{0}/(?P<api_version>[\d_-]+)/cidrcollection$": Route53.dispatch,
    r"{0}/(?P<api_version>[\d_-]+)/cidrcollection/(?P<collection_id>[^/]+)$": Route53.dispatch,
    r"{0}/(?P<api_version>[\d_-]+)/cidrcollection/(?P<collection_id>[^/]+)/cidrblocks$": Route53.dispatch,
}
