...
url_paths = {
    "{0}/.*?$": response.dispatch,
    "/2015-02-01/account-preferences": response.dispatch,
    "/2015-02-01/access-points": response.dispatch,
    "/2015-02-01/access-points/<access_point_id>": response.dispatch,
    "/2015-02-01/create-tags/<file_system_id>": response.dispatch,
    "/2015-02-01/delete-tags/<file_system_id>": response.dispatch,
    ...
    "/2015-02-01/file-systems/<file_system_id>/protection": response.dispatch,
    "/2015-02-01/file-systems/<file_system_id>/replication-configuration": response.dispatch,
    "/2015-02-01/file-systems/replication-configurations": response.dispatch,
    ...
    "/2015-02-01/tags/<file_system_id>/": response.dispatch,
}
