...
class LexModelsV2Response(BaseResponse):
    ...
    def list_bot_aliases(self) -> str:
        ...
        return json.dumps(
            {"botAliasSummaries": summaries, "nextToken": None, "botId": bot_id}
        )
    ...
    def delete_bot_alias(self) -> str:
        ...
        return json.dumps(
            {"botAliasId": bot_alias_id, "botId": bot_id, "botAliasStatus": status}
        )

    def create_bot_locale(self) -> str:
        return json.dumps(
            self.lexv2models_backend.create_bot_locale(
                bot_id=self._get_param("botId"),
                bot_version=self._get_param("botVersion"),
                locale_id=self._get_param("localeId"),
                description=self._get_param("description") or "",
                nlu_intent_confidence_threshold=self._get_param(
    ...
    def describe_bot_locale(self) -> str:
        return json.dumps(
            self.lexv2models_backend.describe_bot_locale(
                bot_id=self._get_param("botId"),
                bot_version=self._get_param("botVersion"),
                locale_id=self._get_param("localeId"),
            )
    ...
    def update_bot_locale(self) -> str:
        return json.dumps(
            self.lexv2models_backend.update_bot_locale(
                bot_id=self._get_param("botId"),
                bot_version=self._get_param("botVersion"),
                locale_id=self._get_param("localeId"),
                description=self._get_param("description") or "",
    ...
    def delete_bot_locale(self) -> str:
        return json.dumps(
            self.lexv2models_backend.delete_bot_locale(
                bot_id=self._get_param("botId"),
                bot_version=self._get_param("botVersion"),
                locale_id=self._get_param("localeId"),
            )
    ...
    def list_bot_locales(self) -> str:
        bot_id = self._get_param("botId")
        bot_version = self._get_param("botVersion")
        summaries = self.lexv2models_backend.list_bot_locales(
        ...
        return json.dumps(
            {
                ...
                "nextToken": None,
                "botLocaleSummaries": summaries,
            }
        )

    def build_bot_locale(self) -> str:
        return json.dumps(
            self.lexv2models_backend.build_bot_locale(
                bot_id=self._get_param("botId"),
                bot_version=self._get_param("botVersion"),
                locale_id=self._get_param("localeId"),
            )
    ...
    def create_bot_version(self) -> str:
        return json.dumps(
            self.lexv2models_backend.create_bot_version(
                bot_id=self._get_param("botId"),
                description=self._get_param("description") or "",
                bot_version_locale_specification=self._get_param(
    ...
    def describe_bot_version(self) -> str:
        return json.dumps(
            self.lexv2models_backend.describe_bot_version(
                bot_id=self._get_param("botId"),
                bot_version=self._get_param("botVersion"),
            )
        )
    ...
    def list_bot_versions(self) -> str:
        ...
        return json.dumps(
            {"botId": bot_id, "botVersionSummaries": summaries, "nextToken": None}
        )
    ...
    def delete_bot_version(self) -> str:
        ...
        return json.dumps(
            {"botId": bot_id, "botVersion": bot_version, "botStatus": status}
        )

    def create_intent(self) -> str:
        return json.dumps(
            self.lexv2models_backend.create_intent(
                bot_id=self._get_param("botId"),
                bot_version=self._get_param("botVersion"),
                locale_id=self._get_param("localeId"),
                ...
                intent_confirmation_setting=self._get_param(
    ...
    def describe_intent(self) -> str:
        return json.dumps(
            self.lexv2models_backend.describe_intent(
    ...
    def update_intent(self) -> str:
        return json.dumps(
            self.lexv2models_backend.update_intent(
                intent_id=self._get_param("intentId"),
                bot_id=self._get_param("botId"),
                bot_version=self._get_param("botVersion"),
                locale_id=self._get_param("localeId"),
    ...
    def create_slot(self) -> str:
        return json.dumps(
            self.lexv2models_backend.create_slot(
                bot_id=self._get_param("botId"),
                bot_version=self._get_param("botVersion"),
                locale_id=self._get_param("localeId"),
                intent_id=self._get_param("intentId"),
    ...
    def describe_slot(self) -> str:
        return json.dumps(
            self.lexv2models_backend.describe_slot(
    ...
    def update_slot(self) -> str:
        return json.dumps(
            self.lexv2models_backend.update_slot(
                slot_id=self._get_param("slotId"),
                bot_id=self._get_param("botId"),
                bot_version=self._get_param("botVersion"),
                locale_id=self._get_param("localeId"),
    ...
    def create_slot_type(self) -> str:
        return json.dumps(
            self.lexv2models_backend.create_slot_type(
                bot_id=self._get_param("botId"),
                bot_version=self._get_param("botVersion"),
                locale_id=self._get_param("localeId"),
    ...
    def describe_slot_type(self) -> str:
        return json.dumps(
            self.lexv2models_backend.describe_slot_type(
                slot_type_id=self._get_param("slotTypeId"),
                bot_id=self._get_param("botId"),
                bot_version=self._get_param("botVersion"),
                locale_id=self._get_param("localeId"),
    ...
    def update_slot_type(self) -> str:
        return json.dumps(
            self.lexv2models_backend.update_slot_type(
                slot_type_id=self._get_param("slotTypeId"),
                bot_id=self._get_param("botId"),
                bot_version=self._get_param("botVersion"),
                locale_id=self._get_param("localeId"),
