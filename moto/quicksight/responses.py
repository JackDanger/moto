...
class QuickSightResponse(BaseResponse):
    ...
    def describe_data_set(self) -> str:
        ...
        return json.dumps(
            {"DataSet": data_set.to_json(), "Status": 200, "RequestId": "request_id"}
        )
    ...
    def list_data_sets(self) -> str:
        ...
        return json.dumps(
            {"DataSetSummaries": data_sets, "Status": 200, "RequestId": "request_id"}
        )
    ...
    def describe_data_set_permissions(self) -> str:
        data_set_id = self._get_param("DataSetId")
        arn, dsid, permissions = self.quicksight_backend.describe_data_set_permissions(
            data_set_id
        )
        return json.dumps(
            {
    ...
    def delete_group_membership(self) -> TYPE_RESPONSE:
        ...
        return (
            200,
            {"status": 200},
            json.dumps({"RequestId": "request_id", "Status": 200}),
        )
    ...
    def describe_ingestion(self) -> str:
        data_set_id = self._get_param("DataSetId")
        ingestion_id = self._get_param("IngestionId")
        ingestion = self.quicksight_backend.describe_ingestion(
            data_set_id, ingestion_id
        )
        return json.dumps(
            {"Ingestion": ingestion.to_json(), "RequestId": "request_id", "Status": 200}
        )
    ...
    def list_ingestions(self) -> str:
        ...
        return json.dumps(
            {
                "Ingestions": [i.to_json() for i in ingestions],
                "RequestId": "request_id",
                "Status": 200,
            }
        )
    ...
    def list_dashboard_versions(self) -> str:
        ...
        return json.dumps(
            {
                "DashboardVersionSummaryList": versions,
                "Status": 200,
                "RequestId": "request_id",
            }
        )
    ...
    def describe_dashboards_qa_configuration(self) -> str:
        return json.dumps(
            {
                "DashboardsQAConfiguration": {"Status": "ENABLED"},
                "Status": 200,
                "RequestId": "request_id",
            }
        )
        ...
        return json.dumps(
            {
                ...
                "RequestId": "request_id",
                "Arn": "mock-arn",
                "SnapshotJobId": "mock-job-id",
            }
        )

    def describe_dashboard_snapshot_job(self) -> str:
        return json.dumps(
            {"Status": 200, "RequestId": "request_id", "JobStatus": "COMPLETED"}
        )
    ...
    def describe_account_subscription(self) -> str:
        ...
        return json.dumps(
            {"AccountInfo": info, "Status": 200, "RequestId": "request_id"}
        )
    ...
    def create_template_alias(self) -> str:
        ...
        return json.dumps(
            {"TemplateAlias": alias.to_dict(), "Status": 200, "RequestId": "request_id"}
        )
    ...
    def list_template_aliases(self) -> str:
        ...
        return json.dumps(
            {"TemplateAliasList": aliases, "Status": 200, "RequestId": "request_id"}
        )
    ...
    def create_theme_alias(self) -> str:
        ...
        return json.dumps(
            {"ThemeAlias": alias.to_dict(), "Status": 200, "RequestId": "request_id"}
        )
    ...
    def list_theme_aliases(self) -> str:
        ...
        return json.dumps(
            {"ThemeAliasList": aliases, "Status": 200, "RequestId": "request_id"}
        )
    ...
    def delete_topic(self) -> str:
        ...
        return json.dumps(
            {"TopicId": topic_id, "Status": 200, "RequestId": "request_id"}
        )
    ...
    def describe_topic_refresh_schedule(self) -> str:
        ...
        result = self.quicksight_backend.describe_topic_refresh_schedule(
            topic_id, dataset_id
        )
        return json.dumps({**result, "Status": 200, "RequestId": "request_id"})
    ...
    def update_ip_restriction(self) -> str:
        ...
        self.quicksight_backend.update_ip_restriction(
            ...
            vpc_endpoint_id_restriction_rule_map=body.get(
    ...
    def search_analyses(self) -> str:
        ...
        return json.dumps(
            {"AnalysisSummaryList": results, "Status": 200, "RequestId": "request_id"}
        )
    ...
    def search_dashboards(self) -> str:
        ...
        return json.dumps(
            {"DashboardSummaryList": results, "Status": 200, "RequestId": "request_id"}
        )
    ...
    def search_data_sets(self) -> str:
        ...
        return json.dumps(
            {"DataSetSummaries": results, "Status": 200, "RequestId": "request_id"}
        )
    ...
    def search_data_sources(self) -> str:
        ...
        return json.dumps(
            {"DataSourceSummaries": results, "Status": 200, "RequestId": "request_id"}
        )
    ...
    def search_folders(self) -> str:
        ...
        return json.dumps(
            {"FolderSummaryList": results, "Status": 200, "RequestId": "request_id"}
        )
    ...
    def search_topics(self) -> str:
        ...
        return json.dumps(
            {"TopicSummaries": results, "Status": 200, "RequestId": "request_id"}
        )
    ...
    def list_role_memberships(self) -> str:
        ...
        return json.dumps(
            {"MembersList": members, "Status": 200, "RequestId": "request_id"}
        )

    def describe_role_custom_permission(self) -> str:
        namespace = self._get_param("Namespace")
        role = self._get_param("Role")
        result = self.quicksight_backend.describe_role_custom_permission(
            namespace, role
        )
        return json.dumps(
            {"CustomPermissionsName": result, "Status": 200, "RequestId": "request_id"}
        )
    ...
    def tag_resource(self) -> str:
        ...
        tags = {tag["Key"]: tag.get("Value") for tag in (self._get_param("Tags") or [])}
    ...
    def list_custom_permissions(self) -> str:
        return json.dumps(
            {"CustomPermissionsList": [], "Status": 200, "RequestId": "request_id"}
        )

    def describe_key_registration(self) -> str:
        return json.dumps(
            {"KeyRegistration": [], "Status": 200, "RequestId": "request_id"}
        )
    ...
    def describe_q_personalization_configuration(self) -> str:
        return json.dumps(
            {"PersonalizationMode": "ENABLED", "Status": 200, "RequestId": "request_id"}
        )
    ...
    def describe_quick_sight_q_search_configuration(self) -> str:
        return json.dumps(
            {"QSearchStatus": "ENABLED", "Status": 200, "RequestId": "request_id"}
        )
    ...
    def start_asset_bundle_export_job(self) -> str:
        return json.dumps(
            {
                "Arn": "mock-arn",
                "AssetBundleExportJobId": "mock-job",
                "Status": 200,
                "RequestId": "request_id",
            }
        )
    ...
    def start_asset_bundle_import_job(self) -> str:
        return json.dumps(
            {
                "Arn": "mock-arn",
                "AssetBundleImportJobId": "mock-job",
                "Status": 200,
                "RequestId": "request_id",
            }
        )
    ...
    def describe_asset_bundle_export_job(self) -> str:
        return json.dumps(
            {"JobStatus": "SUCCESSFUL", "Status": 200, "RequestId": "request_id"}
        )
    ...
    def list_self_upgrades(self) -> str:
        return json.dumps(
            {"SelfUpgradesList": [], "Status": 200, "RequestId": "request_id"}
        )
    ...
    def list_action_connectors(self) -> str:
        return json.dumps(
            {"ActionConnectors": [], "Status": 200, "RequestId": "request_id"}
        )
