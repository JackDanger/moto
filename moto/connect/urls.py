...
url_paths = {
    ...
    "{0}/contacts/(?P<InstanceId>[^/]+)/(?P<ContactId>[^/]+)/associate-user$": ConnectResponse.dispatch,
    ...
    "{0}/hours-of-operations/(?P<InstanceId>[^/]+)/(?P<HoursOfOperationId>[^/]+)/hours$": ConnectResponse.dispatch,
    "{0}/instance/(?P<InstanceId>[^/]+)/lex-bot$": ConnectResponse.dispatch,
    "{0}/instance/(?P<InstanceId>[^/]+)/lex-bots$": ConnectResponse.dispatch,
    "{0}/phone-number/(?P<PhoneNumberId>[^/]+)/contact-flow$": ConnectResponse.dispatch,
    "{0}/traffic-distribution-group/(?P<TrafficDistributionGroupId>[^/]+)/user$": ConnectResponse.dispatch,
    "{0}/users/(?P<InstanceId>[^/]+)/(?P<UserId>[^/]+)/associate-proficiencies$": ConnectResponse.dispatch,
    "{0}/users/(?P<InstanceId>[^/]+)/(?P<UserId>[^/]+)/disassociate-proficiencies$": ConnectResponse.dispatch,
    "{0}/users/(?P<InstanceId>[^/]+)/(?P<UserId>[^/]+)/contact$": ConnectResponse.dispatch,
    "{0}/analytics-data/instance/(?P<InstanceId>[^/]+)/associations$": ConnectResponse.dispatch,
    "{0}/data-tables/(?P<InstanceId>[^/]+)/(?P<DataTableId>[^/]+)/values/delete$": ConnectResponse.dispatch,
    "{0}/data-tables/(?P<InstanceId>[^/]+)/(?P<DataTableId>[^/]+)/values/describe$": ConnectResponse.dispatch,
    "{0}/data-tables/(?P<InstanceId>[^/]+)/(?P<DataTableId>[^/]+)/values/evaluate$": ConnectResponse.dispatch,
    "{0}/data-tables/(?P<InstanceId>[^/]+)/(?P<DataTableId>[^/]+)/values/list-primary$": ConnectResponse.dispatch,
    "{0}/data-tables/(?P<InstanceId>[^/]+)/(?P<DataTableId>[^/]+)/values/list$": ConnectResponse.dispatch,
    "{0}/attached-files/(?P<InstanceId>[^/]+)/(?P<FileId>[^/]+)$": ConnectResponse.dispatch,
    "{0}/contact-flow-modules/(?P<InstanceId>[^/]+)/(?P<ContactFlowModuleId>[^/]+)/version$": ConnectResponse.dispatch,
    "{0}/contact-flow-modules/(?P<InstanceId>[^/]+)/(?P<ContactFlowModuleId>[^/]+)/version/(?P<ContactFlowModuleVersion>[^/]+)$": ConnectResponse.dispatch,
    "{0}/contact-flow-modules/(?P<InstanceId>[^/]+)/(?P<ContactFlowModuleId>[^/]+)/versions$": ConnectResponse.dispatch,
    "{0}/contact-flows/(?P<InstanceId>[^/]+)/(?P<ContactFlowId>[^/]+)/version$": ConnectResponse.dispatch,
    "{0}/contact-flows/(?P<InstanceId>[^/]+)/(?P<ContactFlowId>[^/]+)/version/(?P<ContactFlowVersion>[^/]+)$": ConnectResponse.dispatch,
    "{0}/contact/create-participant$": ConnectResponse.dispatch,
    "{0}/contact/persistent-contact-association/(?P<InstanceId>[^/]+)/(?P<InitialContactId>[^/]+)$": ConnectResponse.dispatch,
    "{0}/push-notification/(?P<InstanceId>[^/]+)/registrations$": ConnectResponse.dispatch,
    "{0}/push-notification/(?P<InstanceId>[^/]+)/registrations/(?P<RegistrationId>[^/]+)$": ConnectResponse.dispatch,
    "{0}/views/(?P<InstanceId>[^/]+)/(?P<ViewId>[^/]+)/versions$": ConnectResponse.dispatch,
    "{0}/views/(?P<InstanceId>[^/]+)/(?P<ViewId>[^/]+)/versions/(?P<ViewVersion>[^/]+)$": ConnectResponse.dispatch,
    "{0}/workspaces/(?P<InstanceId>[^/]+)/(?P<WorkspaceId>[^/]+)/media$": ConnectResponse.dispatch,
    "{0}/workspaces/(?P<InstanceId>[^/]+)/(?P<WorkspaceId>[^/]+)/pages$": ConnectResponse.dispatch,
    "{0}/workspaces/(?P<InstanceId>[^/]+)/(?P<WorkspaceId>[^/]+)/pages/(?P<Page>[^/]+)$": ConnectResponse.dispatch,
    "{0}/effective-hours-of-operations/(?P<InstanceId>[^/]+)/(?P<HoursOfOperationId>[^/]+)$": ConnectResponse.dispatch,
    "{0}/user/federate/(?P<InstanceId>[^/]+)$": ConnectResponse.dispatch,
    "{0}/metrics/current/(?P<InstanceId>[^/]+)$": ConnectResponse.dispatch,
    "{0}/metrics/userdata/(?P<InstanceId>[^/]+)$": ConnectResponse.dispatch,
    "{0}/metrics/historical/(?P<InstanceId>[^/]+)$": ConnectResponse.dispatch,
    "{0}/prompts/(?P<InstanceId>[^/]+)/(?P<PromptId>[^/]+)/file$": ConnectResponse.dispatch,
    "{0}/test-cases/(?P<InstanceId>[^/]+)/(?P<TestCaseId>[^/]+)/(?P<TestCaseExecutionId>[^/]+)/summary$": ConnectResponse.dispatch,
    "{0}/test-cases/(?P<InstanceId>[^/]+)/(?P<TestCaseId>[^/]+)/(?P<TestCaseExecutionId>[^/]+)/records$": ConnectResponse.dispatch,
    "{0}/test-case-executions/(?P<InstanceId>[^/]+)$": ConnectResponse.dispatch,
    "{0}/traffic-distribution/(?P<Id>[^/]+)$": ConnectResponse.dispatch,
    "{0}/traffic-distribution-groups$": ConnectResponse.dispatch,
    "{0}/phone-number/import$": ConnectResponse.dispatch,
    "{0}/analytics-data/instance/(?P<InstanceId>[^/]+)/datasets$": ConnectResponse.dispatch,
    "{0}/contact/associated/(?P<InstanceId>[^/]+)$": ConnectResponse.dispatch,
    "{0}/entity-security-profiles-summary/(?P<InstanceId>[^/]+)$": ConnectResponse.dispatch,
    "{0}/queues/(?P<InstanceId>[^/]+)/(?P<QueueId>[^/]+)/email-addresses$": ConnectResponse.dispatch,
    "{0}/contact/list-real-time-analysis-segments-v2/(?P<InstanceId>[^/]+)/(?P<ContactId>[^/]+)$": ConnectResponse.dispatch,
