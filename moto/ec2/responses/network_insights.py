...
class NetworkInsightsResponse(EC2BaseResponse):
    def create_network_insights_path(self) -> ActionResult:
        ...
        result = {"NetworkInsightsPath": path}
        return ActionResult(result)

    def delete_network_insights_path(self) -> ActionResult:
        path_id = self._get_param("NetworkInsightsPathId")
        path = self.ec2_backend.delete_network_insights_path(path_id)
        result = {"NetworkInsightsPathId": path.id}
        return ActionResult(result)

    def describe_network_insights_paths(self) -> ActionResult:
        ...
        result = {"NetworkInsightsPaths": paths}
        return ActionResult(result)

    def start_network_insights_analysis(self) -> ActionResult:
        path_id = self._get_param("NetworkInsightsPathId")
        ...
        result = {"NetworkInsightsAnalysis": analysis}
        return ActionResult(result)

    def describe_network_insights_analyses(self) -> ActionResult:
        ...
        result = {"NetworkInsightsAnalyses": analyses}
        return ActionResult(result)
