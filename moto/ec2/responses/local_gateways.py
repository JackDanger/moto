...
class LocalGatewayResponse(EC2BaseResponse):
    def create_local_gateway_route_table(self) -> ActionResult:
        ...
        result = {"LocalGatewayRouteTable": table}
    ...
    def describe_local_gateway_route_tables(self) -> ActionResult:
        ...
        result = {"LocalGatewayRouteTables": tables}
        return ActionResult(result)

    def delete_local_gateway_route_table(self) -> ActionResult:
    ...
    def search_local_gateway_routes(self) -> ActionResult:
        table_id = self._get_param("LocalGatewayRouteTableId")
