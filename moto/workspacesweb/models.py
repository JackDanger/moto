...
class FakePortal(BaseModel):
    def __init__(
        ...
        self.data_protection_settings_arn: str | None = None
        self.session_logger_arn: str | None = None
...
class WorkSpacesWebBackend(BaseBackend, TaggableResourcesMixin):
    ...
    def update_trust_store(
        self,
        trust_store_arn: str,
        certificates_to_add: list[str] | None,
        certificates_to_delete: list[str] | None,
    ) -> str:
        if trust_store_arn not in self.trust_stores:
            raise ResourceNotFoundException(f"TrustStore {trust_store_arn} not found")
    ...
    def update_identity_provider(
        ...
        identity_provider_details: dict[str, str] | None,
